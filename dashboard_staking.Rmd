...
# DOT_tokens <- getAccountBalance_acala_token("acala", window = 1, filter = 'filter: {total: {greaterThan: "0"}} ', endpage = endpage)
DOT_tokens <- getAccountBalance_acala_token("acala", window = 1, filter = '', endpage = endpage)
