...
renderPlot({
  ...
  activeUsersStatus <- round(tail(activeUsers$`Active Users`, 2) / activeUsersAvg, 1)
...
renderPlot({
  ...
  avgTradeStatus <- round(tail(avgTrade$`Trades per user`, 2) / avgTradeAvg, 1)
...
renderPlot({
  ...
  tradeVolumeStatus <- round(tail(tradeVolume$`Trading Volume`, 2) / tradeVolumeAvg, 1)
