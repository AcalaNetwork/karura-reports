...
karura_addr[, Balance := Balance / 100]
# karura_addr[,.N]
...
acala_addr[, Balance := Balance / 100]
# acala_addr[,.N]
...
karura_addr[AUSD > 0, AUSD_Status := '1) AUSD Holder']
...
* The Acala / Karura data is as of `r Sys.time()`, but the Polkadot / Kusama balances were obtained a few days earlier. 

```{r fname}

fwrite(karura_addr, "/Users/rogerbos/karura_hubspot.csv")
fwrite(acala_addr, "/Users/rogerbos/acala_hubspot.csv")
